...
> 提炼自 `huashu-design/references/`（animations / animation-best-practices / animation-pitfalls /
> audio-design-rules / sfx-library / gsap-recipes / hero-animation-case-study）。逐条对应原文，可作 spec 的「禁止/必须/考虑」行。
